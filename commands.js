export const systemCommands = {
  ...
  volumeDown: {
    ...
    darwin:
      'osascript -e "set volume output volume (output volume of (get volume settings) - 10)"',
    linux: "amixer -q sset Master 5%-",
    successMessage: "Volume decreased",
  ...
  mute: {
    ...
    successMessage: "Audio toggled mute/unmute",
  ...
  playPause: {
    ...
    successMessage: "Media play/pause toggled",
  ...
  lock: {
    ...
    successMessage: "Computer locked",
  ...
  sleep: {
    ...
    successMessage: "Computer going to sleep 😴",
  ...
  shutdown: {
    ...
    successMessage: "Computer shutting down...",
  ...
  taskManager: {
    ...
    darwin: "",
    linux: "",
    successMessage: "Task Manager opened",
  ...
  paste: {
    ...
    darwin: "1",
    linux: "1",
    successMessage: "Text pasted from clipboard",
